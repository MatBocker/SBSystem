  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        @method('delete')
        @CSRF
        <button type="submit" class="btn btn-success" title="Pagar despesa" onclick="return confirm('Você tem certeza que deseja pagar está despesa? ')"><span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span></button>
        </form>
